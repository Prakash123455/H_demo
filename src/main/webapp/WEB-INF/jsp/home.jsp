...
<style>
body {
	background-image: url("https://images4.alphacoders.com/286/286536.jpg");
...
<body>
	...
	<font color="red">${regsiterd}</font>
	<font color="red">${loginfailed}</font>
	<font color="red">${registraionfailed}</font>
	<div id="id01" class="modal">

		<form class="modal-content animate"
			action="${hostUrl}/login"
			method="POST">
